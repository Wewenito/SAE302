import socket, threading, select, os, time, sys, resource, pdb
...
from popup import Manage_rooms, Manage_demands
...
class Client_handle(QMainWindow):
    ...
    def __init__(self):
        ...
        try:
            self.connect_to_server("127.0.0.1", 11111)
            ...
            if server_response.split("|")[0] == "LOGIN_PROCESS_STEP_2_OK":
                ...
                for users in user_friends:
                    ...
                    if users != "":
                        ...
                        self.user_friends.append([friend_uid, friend_username])
    ...
    def send_input_private_message(self):
        ...
        formatted_time = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
        self.Messages_display.append(f"[{self.user_data['Username']} - {formatted_time}] -> {self.Message_input.text()}")
    ...
    def create_main_ui(self):
        ...
        for friend in self.user_friends:
            ...
            button.setContentsMargins(0, 0, 35, 0)
        ...
        # self.general_widget.setStyleSheet("border: 2px solid red;")
        ...
        self.blabla_widget.setStyleSheet("border: 2px solid red;")
        ...
        self.compta_widget.setStyleSheet("border: 2px solid red;")
        ...
        self.info_widget.setStyleSheet("border: 2px solid red;")
        ...
        self.marketing_widget.setStyleSheet("border: 2px solid red;")
        ...
        self.Message_input.setGeometry(QtCore.QRect(460, 450, 531, 41))
        ...
        self.Main_title.setGeometry(QtCore.QRect(500, 20, 511, 50))
        ...
        self.Main_title.setText(_translate("MainWindow", "MAIN TITLE"))
    ...
    def test_func1(self):
        print("[Client_Handler test_func1 starts]")
        i = 0
        while True:
            i = i + 1
            print(f"Func1 value : {i}")
            time.sleep(3)

    def test_func2(self):
        print("[Client_Handler test_func2 starts]")
        i = 0
        while True:
            i = i + 1
            print(f"Func2 value : {i}")
            time.sleep(1)
    ...
    def append_message_to_room(self, data):
        ...
        try:
            ...
            try:
                #pdb.set_trace()
                self.Messages_display.append(f"[{username} - {datetime}] -> {message}")
                print("append ok")
            except Exception as E:
